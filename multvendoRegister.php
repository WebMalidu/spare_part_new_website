...
<head>
    ...
    <title>Multvendo Register</title>
...
<body class="w-100 mrp-body alg-bg-light-blue">
    <!-- header section-->
    ...
    <div class="mrp-mainbox d-flex  justify-content-center align-items-center">
        <div class="mrp-box alg-bg-light d-flex flex-column align-items-center alg-rounded-small">
            ...
            <div class="pt-4">
                <span class="alg-text-h3 alg-text-blue ">Contact Number</span>
                <div class="mrp-contact-box d-flex">
                    <div>
