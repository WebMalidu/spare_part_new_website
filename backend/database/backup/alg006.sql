...
INSERT INTO `invoice_item` VALUES (12,1,783,'CASE - DOCUMENTS','pp_690426',13,'',0),(13,1,3200,'Front Brake Pad Set','pp_695954',13,'',0),(14,1,783,'CASE - DOCUMENTS','pp_690426',13,'',0),(15,1,20000,'Tensioner Pulley, Timing Belt','pp_634662',13,'',0),(16,1,12000,'Timing Belt','pp_305615',13,'',0),(17,1,2103,'Rear Lip Spoiler','pp_646734',14,'',0),(18,1,783,'CASE - DOCUMENTS','pp_690426',14,'',0),(19,1,3200,'Front Brake Pad Set','pp_695954',14,'',0),(20,1,783,'CASE - DOCUMENTS','pp_690426',14,'',0),(21,1,20000,'Tensioner Pulley, Timing Belt','pp_634662',14,'',0),(22,1,12000,'Timing Belt','pp_305615',14,'',0),(23,1,399,'dasd','pp_785550',15,'',0),(24,1,399,'dasd','pp_785550',16,'',0),(25,1,399,'dasd','pp_785550',17,'',0),(26,1,399,'dasd','pp_785550',18,'',0),(27,1,399,'dasd','pp_785550',19,'',0),(28,1,399,'dasd','pp_785550',20,'',0),(29,1,399,'dasd','pp_785550',21,'',0);
...
CREATE TABLE `seller_details` (
  ...
  `business_hotline_number` varchar(15) NOT NULL,
  `user_user_id` int NOT NULL,
  `owner_nic` varchar(20) NOT NULL,
  PRIMARY KEY (`br_number`),
  KEY `fk_seller_details_user1_idx` (`user_user_id`),
  CONSTRAINT `fk_seller_details_user1` FOREIGN KEY (`user_user_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `user` VALUES (1,1,'Kamal Silva','','kamal@gmail.com','Qwer123$%','Qwer123$%','2023-09-10',0,1),(2,2,'Sunil Ayya','','sunil@gmail.com','Qwer123$%','Qwer123$%','2023-09-10',0,1),(3,2,'kaviska','','kaviska525@gmail.com','7c0230f93a00bb043168efa2a78d7f2e787bed999f86a8ef29cb227b49b55bb6','688c93af927f0b379b4b8371e7acdf68','2023-12-05',0,1),(9,3,'kasun','','kasun@gmmail.com','cae5293f43d47776ab974e7354141bd85044fa06ed202043dbe098331245297f','1260a0ef0a3339d4eafcabb31986e630','2023-12-07',0,1),(11,1,'kaviska','dil','udaramadushan525@gmail.com','0c2d5f3ca8d361e0e6a3e93bade3e51c41981c3a7ba997c5f37d6ff1211c91a0','a52999682b0ca882ebb7d659517b7641','2023-12-16',0,1),(12,2,'Madusha','Pravinda','armadushapravinda@gmail.com','23644e90384cd57b68e224de88b79f8e0a4269badd6f2d92816edb7ffc345aed','1a701cf5283b6b66aea53bf5949da90d','2023-12-17',0,1),(13,2,'admin','admin','testadmin@gmail.com','a1870f93d4a0e974e43ec074f6784cc2170922a3b662ba7f3358313417d87adb','1e99f61c0cce3935a01c80db3ca91d93','2023-12-17',0,1);
...
INSERT INTO `user_type` VALUES (1,'user'),(2,'seller'),(3,'pending_seller'),(4,'blocked_Seller');
...
-- Dump completed on 2023-12-26 22:40:15
