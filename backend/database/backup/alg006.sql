...
CREATE TABLE `cart` (
  ...
  `vehicle_parts_parts_id` int NOT NULL,
  PRIMARY KEY (`cart_id`),
...
INSERT INTO `category` VALUES (1,'Control Cables'),(2,'Brake System');
...
INSERT INTO `category_item` VALUES (1,'Brake Cable',1),(2,'Asselator Cable',1),(3,'DWS',2);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `makers` (
  `makers_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `shipping_details` (
  ...
  KEY `fk_shipping_details_city1_idx` (`city_city_id`),
  KEY `fk_shipping_details_user1_idx` (`user_user_id`),
  CONSTRAINT `fk_shipping_details_city1` FOREIGN KEY (`city_city_id`) REFERENCES `city` (`city_id`),
...
CREATE TABLE `vehicle_models` (
  ...
  KEY `fk_models_makers1_idx` (`makers_makers_id`),
  ...
  CONSTRAINT `fk_models_makers1` FOREIGN KEY (`makers_makers_id`) REFERENCES `makers` (`makers_id`),
...
INSERT INTO `vehicle_models` VALUES (1,'Honda Vezel',2,1,1,1,2);
...
CREATE TABLE `vehicle_parts` (
  ...
  `category_item_category_item_id` int NOT NULL,
...
-- Dump completed on 2023-09-10 18:02:53
