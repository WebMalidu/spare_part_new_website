...
<section class="alg-bg-darker alg-rounded-small my-2 d-flex h-100">
       <div class="p-2 col-3 flex-grow-1">
              <div class="px-2 algbg alg-rounded-small">
                     <button onclick="toggleHomeSection('makers')" class="alg-btn-pill my-2 w-100"><span class="d-none d-lg-block">Makers</span><i class="bi bi-box d-block d-lg-none"></i></button>
              </div>
       </div>
